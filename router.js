/**
 * Created by jiehua.yang on 2014/11/28.
 */
...
Router.prototype.router = function(req, res, next) {
	...
	// 通过uri获得box信息
	var params = UrlUtil.parse(reqUri, true).query;
	this.boxes(reqUri, params, (function(boxes) {
		// 获得页面数据
		var data = this.join(boxes);

		// 获得html
		var html = this.toHTML(data);
	...
	this.controllers(paths, (function(controllers) {
		...
		controllers.forEach(function(controller, index) {
			...
			if (controller.params) {
				boxReq.params = controller.params(boxReq, this) || {};
			}
